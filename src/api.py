...
api_router.include_router(external_product_router, prefix="/external-product", tags=["external-product"])
...
api_router.include_router(project_geography_router, prefix="/project-geography", tags=["project-geography"])
...
api_router.include_router(project_keyword_router, prefix="/project-keyword", tags=["project-keyword"])